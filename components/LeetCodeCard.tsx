...
export default function LeetcodeCard() {
    ...
    if (!hasContestData) {
        return (
            <div className="glass-card p-6 sm:p-8 rounded-3xl border border-white/10 shadow-xl max-w-xl hover:shadow-2xl hover:border-amber-500/20 transition-all duration-300 relative group overflow-hidden w-full mx-auto animate-fade-in">
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl w-full mx-auto items-stretch">
            {/* Card 1: Solved Stats */}
